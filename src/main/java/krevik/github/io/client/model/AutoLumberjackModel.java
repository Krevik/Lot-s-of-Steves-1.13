package krevik.github.io.client.model;
...
@OnlyIn(Dist.CLIENT)
public class AutoLumberjackModel<T extends LivingEntity> extends BipedModel<T> {
    ...
    public AutoLumberjackModel(float modelSize, boolean smallArmsIn) {
