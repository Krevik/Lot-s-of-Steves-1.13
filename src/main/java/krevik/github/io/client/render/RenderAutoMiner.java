...
import krevik.github.io.client.model.AutoMinerModel;
...
@OnlyIn(Dist.CLIENT)
public class RenderAutoMiner extends BipedRenderer<EntityAutoMiner, BipedModel<EntityAutoMiner>>
{
    ItemRenderer itemRenderer;
    ItemStack stackToRender;
    ItemEntity itemEntity;
    public RenderAutoMiner(EntityRendererManager renderManagerIn)
    {
        super(renderManagerIn, new AutoMinerModel<>(1.0f,false), 1F);
        itemRenderer = Minecraft.getInstance().getItemRenderer();
    }

    @Override
    public void doRender(EntityAutoMiner entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    protected void renderLivingLabel(EntityAutoMiner entityIn, double x, double y, double z, int maxDistance) {
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityAutoMiner entity)
    {
        return TextureLocationsRef.AUTOMINERLOC;
    }

    public static class Factory implements IRenderFactory<EntityAutoMiner> {

        @Override
        public EntityRenderer<? super EntityAutoMiner> createRenderFor(EntityRendererManager manager) {
            return new RenderAutoMiner(manager);
        }

    }

    @Override
    protected void applyRotations(EntityAutoMiner entityLiving, float p_77043_2_, float rotationYaw, float partialTicks)
    {
