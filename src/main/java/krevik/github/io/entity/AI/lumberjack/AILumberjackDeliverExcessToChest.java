...
public class AILumberjackDeliverExcessToChest extends Goal {
        ...
        int pathTimer;
        World world;
        public AILumberjackDeliverExcessToChest(EntityAutoLumberjack npc){
            NPC=npc;
            runDelay=100;
            actualDelay=0;
        ...
        public boolean shouldExecute() {
            ...
            if(actualDelay>=runDelay){
                chestPoses=helper.getChestPosesWithFreeSlotsLumberjack(NPC);
                excessItemStacks=helper.getExcessItemsLumberjack(NPC);
        ...
        public void tick() {
            if(destinationBlock!=null){
                NPC.setWhatIAmActuallyDoing("Delivering excess to chest");
                ...
                if(getIsAboveDestination()||pathTimer>=getPathTimerTimeout()){
                    BlockPos nearestChestPos=helper.getNearestChestPosLumberjack(NPC,chestPoses);
                ...
                destinationBlock=helper.getNearestChestPosLumberjack(NPC,chestPoses);
